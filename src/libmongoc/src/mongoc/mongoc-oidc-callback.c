...
char *
mongoc_oidc_redential_get_access_token(mongoc_oidc_credential_t *credential)
{
    return credential->access_token;
}

int64_t
mongoc_oidc_redential_get_expires_in_seconds(mongoc_oidc_credential_t *credential)
{
